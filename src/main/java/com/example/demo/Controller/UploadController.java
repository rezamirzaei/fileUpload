...
public class UploadController {
    ...
    /**
     * Handle file upload - streams directly to disk for large files.
     */
    @PostMapping("/upload")
    ...
    /**
     * Download file with streaming - supports resume/range requests for large files.
     */
    ...
    /**
     * REST API endpoint for storage statistics.
     */
